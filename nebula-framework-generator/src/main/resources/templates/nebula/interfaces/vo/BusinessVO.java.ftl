...
package ${templateTable.packageName}.${templateTable.javaTableName[0]?lower_case+templateTable.javaTableName[1..]}.interfaces.vo;
...
@Data
public class ${templateTable.javaTableName}VO {
