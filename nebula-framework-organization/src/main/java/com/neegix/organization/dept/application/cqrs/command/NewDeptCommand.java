...
public class NewDeptCommand implements ICommand<Void> {
    private final DeptEntity deptEntity;

    public NewDeptCommand(DeptEntity deptEntity) {
    ...
    public Void execute(ApplicationContext context) {
        ...
        deptMapper.insert(DeptConverter.INSTANCE.covertDO(deptEntity));
        return null;
    }
}
