...
public class NewPostCommand implements ICommand<Void> {
    private final PostEntity postEntity;

    public NewPostCommand(PostEntity postEntity) {
    ...
    public Void execute(ApplicationContext context) {
        ...
        postMapper.insert(PostConverter.INSTANCE.covertDO(postEntity));
        return null;
    }
}
