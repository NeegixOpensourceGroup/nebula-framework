...
public class UpdatePsnCommand implements ICommand<Void> {
    private final PsnEntity psnEntity;

    public UpdatePsnCommand(PsnEntity psnEntity) {
    ...
    public Void execute(ApplicationContext context) {
        ...
        transactionTemplate.execute(status -> {
            ...
            psnMapper.updateByPrimaryKey(PsnConverter.INSTANCE.covertDO(psnEntity));
