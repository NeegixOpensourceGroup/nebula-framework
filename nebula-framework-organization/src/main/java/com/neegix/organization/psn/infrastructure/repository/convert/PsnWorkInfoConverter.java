...
@Mapper
public interface PsnWorkInfoConverter {

   PsnWorkInfoConverter INSTANCE = Mappers.getMapper(PsnWorkInfoConverter.class);

   PsnWorkInfoDO covertDO(PsnWorkInfoValue psnWorkInfoValue);
