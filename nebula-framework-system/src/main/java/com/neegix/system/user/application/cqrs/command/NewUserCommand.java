...
public class NewUserCommand implements ICommand<Void> {
    private final UserEntity userEntity;

    public NewUserCommand(UserEntity userEntity) {
    ...
    public Void execute(ApplicationContext context) {
        ...
        userMapper.insert(UserConverter.INSTANCE.covertDO(userEntity));
        return null;
    }
}
