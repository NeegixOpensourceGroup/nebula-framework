...
public class UpdateMenuCommand implements ICommand<Void> {
    private final MenuEntity menuEntity;

    public UpdateMenuCommand(MenuEntity menuEntity) {
    ...
    public Void execute(ApplicationContext context) {
        ...
        menuMapper.updateByPrimaryKey(MenuConverter.INSTANCE.covertDO(menuEntity));
        return null;
    }
}
