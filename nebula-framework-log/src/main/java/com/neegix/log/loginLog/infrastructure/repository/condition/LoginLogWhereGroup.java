package com.neegix.log.loginLog.application.cqrs.query.condition;
...
public class LoginLogWhereGroup extends WhereGroups {
    ...
    public LoginLogWhereGroup andCreateTimeBetween(Instant value1, Instant value2) {
    ...
    public LoginLogWhereGroup andCreateTimeNotBetween(Instant value1, Instant value2) {
    ...
    public LoginLogWhereGroup andUpdateTimeBetween(Instant value1, Instant value2) {
    ...
    public LoginLogWhereGroup andUpdateTimeNotBetween(Instant value1, Instant value2) {
