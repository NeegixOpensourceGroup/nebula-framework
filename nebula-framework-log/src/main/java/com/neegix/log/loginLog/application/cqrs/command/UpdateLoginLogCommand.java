...
public class UpdateLoginLogCommand implements ICommand<Void> {
    private final LoginLogEntity loginLogEntity;

    public UpdateLoginLogCommand(LoginLogEntity loginLogEntity) {
    ...
    public Void execute(ApplicationContext context) {
        ...
        loginLogMapper.updateByPrimaryKey(LoginLogConverter.INSTANCE.covertDO(loginLogEntity));
        return null;
    }
}
